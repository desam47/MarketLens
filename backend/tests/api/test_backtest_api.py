...
def _mock_run(**kwargs):
    defaults = dict(
        ...
        median_return_5d=3.0,
        median_return_20d=7.5,
        max_drawdown=-8.5,
        sharpe_ratio=1.2,
        profit_factor=1.5,
        mfe_avg=4.2,
        mae_avg=-2.1,
        signal_frequency=0.048,
...
def _mock_trade(**kwargs):
    defaults = dict(
        ...
        entry_price=195.0,
        exit_date_1d=datetime(2025, 6, 2),
        exit_price_1d=197.0,
        return_1d=1.0256,
        exit_date_5d=datetime(2025, 6, 6),
        exit_price_5d=200.0,
        return_5d=2.5641,
        exit_date_20d=datetime(2025, 6, 27),
        exit_price_20d=205.0,
        return_20d=5.1282,
        mfe=6.5,
        mae=-2.3,
    )
...
class TestBacktestAPI(unittest.TestCase):
    ...
    def test_create_backtest_success(self):
        with (
            patch("backend.api.backtest.router.backtest_engine") as mock_engine,
    ...
    def test_get_trades_found(self):
        with patch("backend.api.backtest.router.BacktestRepository") as MockRepo:
            ...
            MockRepo.return_value.get_trades.return_value = [
                _mock_trade(id=1),
                _mock_trade(id=2, signal="MACD_BULLISH"),
            ]
